...
<@layout.registrationLayout displayMessage=messagesPerField.exists('global') displayRequiredFields=true
    asideTitle="Create your account"
    asideBody="One place for every bank account, credit card and transaction — set up takes less than a minute."
    asideCtaHref=url.loginUrl
    asideCtaLabel="Already have an account? Sign in."; section>
